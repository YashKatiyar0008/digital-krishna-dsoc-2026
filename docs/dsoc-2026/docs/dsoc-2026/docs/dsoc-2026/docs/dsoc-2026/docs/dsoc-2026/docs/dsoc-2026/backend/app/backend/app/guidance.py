...
- Basic concern classification
- Structured guidance generation
- Safety-oriented fallback messaging
- Clear separation between reflection and reviewed scripture

It does not connect to private models, production databases,
...
def classify_concern(message: str) -> str:
    """Classify the concern using transparent keyword matching."""
...
def requires_safety_response(message: str) -> bool:
    """Detect a small set of immediate-safety expressions."""
...
def build_english_content(category: str) -> dict[str, object]:
    ...
    category_guidance: dict[str, dict[str, object]] = {
        "Academic stress": {
            "acknowledgement": (
                "Academic pressure can make every task feel heavier than it "
                "really is. You do not need to solve everything at once."
            ),
            "explanation": (
            ...
            "steps": [
                ...
                (
                    "Measure effort",
                    "At the end of the day, record the effort you made rather "
                    "than judging yourself only by the result.",
                ),
            ],
            "question": "What is the smallest useful study action you can take now?",
        },
        "Career uncertainty": {
            "acknowledgement": (
                "Uncertainty about the future is uncomfortable, especially "
                "when you feel pressure to choose the perfect path."
            ),
            "explanation": (
                "A career is usually shaped through repeated experiments, "
                "skills, feedback, and responsible decisions rather than one "
                "perfect prediction."
            ),
            "steps": [
                (
                    "List your current strengths",
                    "Write three skills you already possess and one skill you "
                    "want to improve.",
                ),
                (
                    "Run a small experiment",
                    "Complete one course, project, application, or conversation "
            ...
            "question": "What small experiment could give you useful career evidence this week?",
        },
        "Anger and frustration": {
            "acknowledgement": (
                "Anger often appears when something feels unfair, blocked, or "
                "outside your control."
            ),
            "explanation": (
                "Pausing before acting does not weaken you. It gives you the "
                "space to choose a response that protects your values and "
                "relationships."
            ),
            "steps": [
                (
                    "Pause the reaction",
                    "Step away briefly before replying or making an important decision.",
                ),
                (
                ...
                (
                    ...
                    "Return to the situation only when you can speak clearly "
                    "without insulting or threatening anyone.",
                ),
            ],
        ...
        "Fear and worry": {
            "acknowledgement": (
                "Worry can make uncertain possibilities feel like confirmed outcomes."
            ),
            "explanation": (
            ...
            "steps": [
                (
                    ...
                    "Write what you know for certain and what your mind is predicting.",
                ),
                (
                    "Ground your attention",
                    "Take a slow breath and notice your surroundings before deciding.",
                ),
                (
            ...
            "question": "Which part of this situation is actually within your control?",
        },
        "Motivation and discipline": {
            "acknowledgement": (
                "Low motivation does not always mean you are incapable. "
                "Sometimes the task is unclear, too large, or disconnected "
                "from a meaningful routine."
            ),
            "explanation": (
            ...
            "steps": [
                ...
                (
                    "Create a fixed cue",
                    "Connect the task to a regular time, place, or daily activity.",
                ),
                (
                    "Track consistency",
        ...
        "Decision-making": {
            ...
            "steps": [
                ...
                (
                    ...
                    "List the likely short-term and long-term effects of each option.",
                ),
                (
                    "Check your values",
                    "Choose the option that best supports honesty, responsibility, "
                    "and sustainable progress.",
                ),
            ],
            "question": "Which option best matches the person you want to become?",
        },
    }
    ...
    return category_guidance.get(
        category,
        {
            ...
            "question": "What is one responsible action available to you today?",
        },
    )


def build_hindi_content(category: str) -> dict[str, object]:
    """Create a Hindi guidance response."""
    ...
    return {
        ...
        "steps": [
            (
                ...
                "जो हुआ है उसे सरल शब्दों में लिखें और अनुमान को तथ्य से अलग करें।",
            ),
            (
                "एक छोटा कदम चुनें",
                "ऐसा कार्य चुनें जिसे आप आज सुरक्षित और जिम्मेदारी से पूरा कर सकें।",
            ),
            (
                "शांत होकर समीक्षा करें",
                "कार्य के बाद देखें कि आपने क्या सीखा और अगला कदम क्या होना चाहिए।",
            ),
        ],
...
def build_hinglish_content(category: str) -> dict[str, object]:
    """Create a Hinglish guidance response."""
    ...
    return {
        ...
        "steps": [
            (
                ...
                "Jo hua hai use simple words mein likho aur facts ko assumptions se alag karo.",
            ),
            (
            ...
            (
                "Review karo",
                "Action ke baad dekho ki kya seekha aur next step kya hona chahiye.",
            ),
        ],
...
def generate_guidance(request: GuidanceRequest) -> GuidanceResponse:
    """Generate a structured public-demo response."""

    category = classify_concern(request.message)

    if request.language == "hi":
        content = build_hindi_content(category)
    elif request.language == "hinglish":
        content = build_hinglish_content(category)
    else:
