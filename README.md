...
Digital Krishna AI is an AI-powered spiritual guidance and reflective
learning platform that connects modern personal challenges with
culturally grounded teachings, practical reflection, stories, and
multilingual experiences.

## DSOC Summer Edition 2026

**Primary track:** Artificial Intelligence & Intelligent Systems

This repository contains the sanitized public submission prepared for
DSOC Summer Edition 2026.

The private production repository is not published because it contains
internal configuration and private project information. Only reviewed
...
Request Validation
    ↓
Language and Concern Classification
    ↓
Safety Screening
    ↓
Scripture Retrieval
